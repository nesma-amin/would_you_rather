...
let users = {
  ...
  johndoe: {
    ...
    questions: ['6ni6ok3ym7mf1p33lnez', 'xj352vofupe1dqz9emx13r','hj352vofupe1dqz9emx13z'],
  }
...
let questions = {
  ...
  "hj352vofupe1dqz9emx13z": {
    id: 'hj352vofupe1dqz9emx13z',
    author: 'johndoe',
    timestamp: 1493579767190,
    optionOne: {
      votes: [],
...
// export function _saveQuestion (question) {
  ...
  return new Promise((res, rej) => {
    ...
    setTimeout(() => {
      ...
      console.log("**users[author]",users[author])
